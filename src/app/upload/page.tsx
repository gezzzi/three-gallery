...
import { Upload, X, File, Info, Tag, DollarSign, Lock } from 'lucide-react'
...
export default function UploadPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <h1 className="mb-8 text-3xl font-bold">3Dモデルをアップロード</h1>
        ...
        <div className="space-y-4 rounded-lg bg-white p-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border px-3 py-2 focus:border-blue-500 focus:outline-none"
              rows={4}
              placeholder="モデルの詳細な説明を入力してください"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border px-3 py-2 focus:border-blue-500 focus:outline-none"
              placeholder="キャラクター, ファンタジー, アニメーション（カンマ区切り）"
            />
          </div>
        </div>
